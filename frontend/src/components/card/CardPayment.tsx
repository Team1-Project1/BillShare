...
export default function CardPayment({ payment, onDeletePaymentSuccess }: CardPaymentProps) {
                                ...
                                <div>
                                    ...
                                    {isEditing ? (
                                        <div className="flex items-center gap-3">
                                            ...
                                            />
                                            <button onClick={updatePayment} className="p-2 bg-[#5BC5A7] text-white rounded-md">
                                                <FiCheck />
                                            </button>
                                            <button onClick={() => setIsEditing(false)} className="p-2 bg-gray-300 text-gray-800 rounded-md">
                                                <FiX />
                                            </button>
                                        </div>
                                    ) : (
